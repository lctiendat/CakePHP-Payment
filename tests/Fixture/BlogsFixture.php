...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'content' => ['type' => 'string', 'length' => 10000, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'thumbnail' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'created' => '2021-12-10 11:24:55',
                'modified' => '2021-12-10 11:24:55',
            ],
        ];
        parent::init();
    }
